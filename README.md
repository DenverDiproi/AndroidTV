...
#API & Data structure
the Metro style is construted by two kinds of elements:
...
###Album
http://host/game(video/app)/album?id=664
return album

###Category
http://host/game(video/app)/category?id=12346
return album
 
Note:
Album and Category are most some concept. 
